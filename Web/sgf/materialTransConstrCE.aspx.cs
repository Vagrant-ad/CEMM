...
{
    public partial class materialTransConstrCE : System.Web.UI.Page
    {
        ...
        protected void btnPie_Click(object sender, EventArgs e)
        {
            ...
            int selectTableid;
            string targetFile, suffix = "pie02MateTranCons.png";
            ...
            double[] quantities = new double[3] { 0, 0, 0};
            try
            {
                quantities[0] = resultInfoBll.GetMateCEmission(selectTableid); //材料生产碳排放
                quantities[1] = resultInfoBll.GetTransCEmission(selectTableid); //材料运输碳排放
                quantities[2] = Convert.ToDouble(resultInfoMdl.total_emission) - quantities[0] - quantities[1]; //现场施工碳排放
            }
        ...
        private void DrawPieChart(Graphics graphics, double[] values, string[] labels, Rectangle area)
        {
            ...
            using (Font titleFont = new Font("Microsoft YaHei", 14, FontStyle.Bold))
            {
                ...
                // 添加图标题
                string titleStr = "材料生产、材料运输、现场施工碳排放统计";
