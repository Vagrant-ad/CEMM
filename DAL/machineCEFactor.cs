...
namespace CEMM.DAL
{
	...
	public partial class machineCEFactor
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("mfid", "machineCEFactor"); 
		}
		...
		public bool Exists(int mfid)
		{
			...
			strSql.Append("select count(1) from machineCEFactor");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into machineCEFactor(");
			strSql.Append("mfid,name,code,specific,unit,emissfactor,standardid)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update machineCEFactor set ");
			...
			parameters[4].Value = model.emissfactor;
			parameters[5].Value = model.standardid;
			parameters[6].Value = model.mfid;
		...
		public bool Delete(int mfid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from machineCEFactor ");
			strSql.Append(" where mfid=@mfid ");
			SqlParameter[] parameters = {
					new SqlParameter("@mfid", SqlDbType.Int,4)			};
			parameters[0].Value = mfid;
		...
		public CEMM.Model.machineCEFactor GetModel(int mfid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 mfid,name,code,specific,unit,emissfactor,standardid from machineCEFactor ");
			strSql.Append(" where mfid=@mfid ");
			SqlParameter[] parameters = {
					new SqlParameter("@mfid", SqlDbType.Int,4)			};
			parameters[0].Value = mfid;
		...
		/// 得到一个对象实体
		/// </summary>
		public CEMM.Model.machineCEFactor DataRowToModel(DataRow row)
		{
			CEMM.Model.machineCEFactor model=new CEMM.Model.machineCEFactor();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select mfid,name,code,specific,unit,emissfactor,standardid ");
			strSql.Append(" FROM machineCEFactor ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from machineCEFactor T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "machineCEFactor";
