...
namespace CEMM.Web.materialCEFactor
{
	...
	private void ShowInfo(int mfid)
	{
		...
		this.txtunitmass.Text=model.unitmass.ToString();
		...
		public void btnSave_Click(object sender, EventArgs e)
		{
			...
			if(!PageValidate.IsDecimal(txtunitmass.Text))
			{
				strErr+="unitmass格式错误！\\n";	
			}
			...
			decimal unitmass=decimal.Parse(this.txtunitmass.Text);
