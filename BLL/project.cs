...
namespace CEMM.BLL
{
	...
	{
		private readonly CEMM.DAL.project dal=new CEMM.DAL.project();
		public project()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public CEMM.Model.project GetModelByCache(string projectid)
		{
			...
			return (CEMM.Model.project)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<CEMM.Model.project> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<CEMM.Model.project> DataTableToList(DataTable dt)
		{
			List<CEMM.Model.project> modelList = new List<CEMM.Model.project>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				CEMM.Model.project model;
