...
namespace CEMM.BLL
{
	...
	{
		private readonly CEMM.DAL.sectionwork dal=new CEMM.DAL.sectionwork();
		public sectionwork()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public CEMM.Model.sectionwork GetModelByCache(string sectionid)
		{
			
			string CacheKey = "sectionworkModel-" + sectionid;
			...
			return (CEMM.Model.sectionwork)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<CEMM.Model.sectionwork> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<CEMM.Model.sectionwork> DataTableToList(DataTable dt)
		{
			List<CEMM.Model.sectionwork> modelList = new List<CEMM.Model.sectionwork>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				CEMM.Model.sectionwork model;
