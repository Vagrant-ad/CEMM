<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="directiindirect.aspx.cs" Inherits="CEMM.Web.sgf.directiindirect" %>
        ...
        <div class="container">
            <div class="header">
                <asp:Label ID="Label1" runat="server">
                    <i class="fas fa-leaf"></i>直接间接碳排放量
                </asp:Label>
            </div>
            ...
            <div class="content">
                <div class="control-panel">
                    <div class="control-row">
                        ...
                        <div class="button-group">
                            <asp:Button ID="btnPie" runat="server" OnClick="btnPie_Click" CssClass="button pie" BackColor="#33CC33" Text="柱状图" />
                        </div>
                ...
                <%--<div class="chart-container">--%>
                    <asp:Label ID="Label2" runat="server">
                        <i class="fas fa-chart-pie"></i>直接间接碳排放量
                    </asp:Label>
                    <hr />
                    <asp:Image ID="Image1" runat="server" align="center"/>
                <%--</div>--%>
                <div id="resultContainer" runat="server" style="margin:20px; padding:15px;">
                    <%-- 结果将在这里显示 --%>
                </div>
