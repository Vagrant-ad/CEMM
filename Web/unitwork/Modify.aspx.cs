...
namespace CEMM.Web.unitwork
{
    ...
    {       
        		...
        		protected void Page_Load(object sender, EventArgs e)
		{
			if (!Page.IsPostBack)
			{
				...
				{
					string workid= Request.Params["id"];
					ShowInfo(workid);
				}
			}
		}
	...
	private void ShowInfo(string workid)
	{
		...
		this.txtworkname.Text=model.workname;
		this.txtlotid.Text=model.lotid;
		this.txtworkstartdate.Text=model.workstartdate.ToString();
		this.txtworkenddate.Text=model.workenddate.ToString();
		...
		public void btnSave_Click(object sender, EventArgs e)
		{
			...
			string workid=this.lblworkid.Text;
